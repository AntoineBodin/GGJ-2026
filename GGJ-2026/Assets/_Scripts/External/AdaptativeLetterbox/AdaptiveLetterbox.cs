...
public class AdaptiveLetterbox : MonoBehaviour
{
    ...
    [SerializeField] private bool useBackgroundClearCamera = true;
    ...
    private void EnsureClearCamera()
    {
        ...
        {
            if (clearCamera != null) clearCamera.enabled = false;
            return;
        }
        ...
        if (clearCamera == null)
        {
            ...
            if (t != null) clearCamera = t.GetComponent<Camera>();
    ...
    private void SyncClearCamera()
    {
        if (clearCamera == null)
        {
            if (useBackgroundClearCamera) EnsureClearCamera();
            return;
        }
